    ...
    {   opcion = menu_principal();
        ...
        case 5:// MESAS
            ...
            {   op1 = menu_mesas();
                ...
                case 1:
                    system("cls");
                    printf("		%c%c%cPrecauci%cn!!! \n Al momento de cargar una mesa, ya no se podr%c crear, modificar ni eliminar ning%cn Partido.\n", 33,33,33, 162, 160, 163);
                    printf(" %cDesea continuar?\n\n\t[1]SI [0]NO\n\n>> ", 168);
                    fflush(stdin);
                    scanf("%i", &continuar);
                    if (continuar == 1)
                        escribirMesa();
